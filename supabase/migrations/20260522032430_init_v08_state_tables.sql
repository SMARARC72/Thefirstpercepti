...
-- Source: extracted from `database/schema.postgres.generated.sql` lines 3652-3761.
--
...
--
-- RLS enable per-table emitted by gen-ddl. Service-role + per-campaign read
-- policies land in Phase 5a.9.
-- ============================================================================
